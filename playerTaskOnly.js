...
PlayerTaskOnly.prototype.jumpToTask = function(taskId){


}


PlayerTaskOnly.prototype.deepDive = function(arr){
...
PlayerTaskOnly.prototype.startNextTask = function() {
    var self = this;
...
PlayerTaskOnly.prototype.startNextTrial = function() {
    var self = this;
...
PlayerTaskOnly.prototype.startNextPageOrFrame = function() {
...
PlayerTaskOnly.prototype.addTrialViews = function (trialIter,trialLoop) {
...
PlayerTaskOnly.prototype.getRandomizedTrialId = function () {
    return this.currentTrialIdx;
};

PlayerTaskOnly.prototype.getTrialId = function () {
    return this.trialIter;
};

PlayerTaskOnly.prototype.getBlockId = function () {
    return this.currentBlockIdx;
};


PlayerTaskOnly.prototype.finishSessionWithError = function(err_msg) {
...
PlayerTaskOnly.prototype.finishSession = function() {
...
PlayerTaskOnly.prototype.init = function() {
    var self = this;
